...
import { getCustomerList } from '../../models/getCustomerList';  // Import the getDeals function

// API handler for getting the total deals (order count)
export async function GET(req: NextRequest) {
  try {
    const totalDeals = await getCustomerList();  // Fetch total deals from the database
